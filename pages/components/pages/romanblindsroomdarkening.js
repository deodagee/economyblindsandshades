...
const RomanBlindsRoomDarkening = () => {
  ...
  const fetchLatestData = async () => {
    try {
      ...
      if (latestData) {
        ...
        const inchPricesWidthInsideMount = JSON.parse(latestData.inchPricesAfterWidthInsideMountRomanBlindsRoomDarkening || "{}");

        setinchPricesAfterWidthInsideMountRomanBlindsRoomDarkening(inchPricesWidthInsideMount);

        const inchPricesWidthOutsideMount = JSON.parse(latestData.inchPricesAfterWidthOutsideMountRomanBlindsRoomDarkening || "{}");
        setinchPricesAfterWidthOutsideMountRomanBlindsRoomDarkening(inchPricesWidthOutsideMount);

        const inchPricesHeightInsideMount = JSON.parse(latestData.inchPricesAfterHeightInsideMountRomanBlindsRoomDarkening || "{}");
        setinchPricesAfterHeightInsideMountRomanBlindsRoomDarkening(inchPricesHeightInsideMount);

        const inchPricesHeightOutsideMount = JSON.parse(latestData.inchPricesAfterHeightOutsideMountRomanBlindsRoomDarkening || "{}");
        setinchPricesAfterHeightOutsideMountRomanBlindsRoomDarkening(inchPricesHeightOutsideMount);



        const lastSetPriceWidthInsideMount = inchPricesWidthInsideMount[selectedInchesWidthInsideMount];
        setnewSetPriceInchesWidthInsideMountRomanBlindsRoomDarkening(lastSetPriceWidthInsideMount);

        const lastSetPriceWidthOutsideMount = inchPricesWidthOutsideMount[selectedInchesWidthOutsideMount];
        setnewSetPriceInchesWidthOutsideMountRomanBlindsRoomDarkening(lastSetPriceWidthOutsideMount);

        const lastSetPriceHeightInsideMount = inchPricesHeightInsideMount[selectedInchesHeightInsideMount];
        setnewSetPriceInchesHeightInsideMountRomanBlindsRoomDarkening(lastSetPriceHeightInsideMount);

        const lastSetPriceHeightOutsideMount = inchPricesHeightOutsideMount[selectedInchesHeightOutsideMount];
        setnewSetPriceInchesHeightOutsideMountRomanBlindsRoomDarkening(lastSetPriceHeightOutsideMount);
  ...
  const handleLiftFeatureEllipsess = (ellipseNumber) => {
    ...
    switch (ellipseNumber) {
      case 1:
        newTotalPrice = WandPriceCMSRomanBlindsRoomDarkening;
        break;

      case 2:
        newTotalPrice = cordlesspriceCMSRomanBlindsRoomDarkening;
        break;

      case 3:
        newTotalPrice = motorizedpriceCMSRomanBlindsRoomDarkening;
        break;
  ...
  const getTotalPrice = () => {
    ...
    switch (active_inside_outside_ellipse) {
      case 1:
        totalPrice = totalpricecalculated + (active_wand_left_choice === 4 ? WandPriceCMSZebrablindsRomanBlindsRoomDarkening : 0) + (active_wand_right_choice === 5 ? WandPriceCMSZebrablindsRomanBlindsRoomDarkening : 0);
        break;
      case 2:
  ...
  const [RomanBlindsRoomDarkeningContent, setRomanBlindsRoomDarkeningContent] = useState('');

  useEffect(() => {
    const RomanBlindsRoomDarkeningElement = document.querySelector(`.${styles.room_darkening_element}`);
    if (RomanBlindsRoomDarkeningElement) {
      setRomanBlindsRoomDarkeningContent(RomanBlindsRoomDarkeningElement.textContent || RomanBlindsRoomDarkeningElement.innerText);
    }
  }, []);
  ...
  const handleScrolledInchesWhenClickedHeightInsideMount = (inchesHeightInsideMount) => {
    ...
    const newSetPriceHeightInsideMount = inchPricesAfterHeightInsideMountRomanBlindsRoomDarkening[inchesHeightInsideMount];
    setnewSetPriceInchesHeightInsideMountRomanBlindsRoomDarkening(newSetPriceHeightInsideMount !== undefined ? newSetPriceHeightInsideMount : "");
    ...
    if (newSetPriceHeightInsideMount === undefined && inchesHeightInsideMount % 5 !== 0) {
      ...
      const nearestMultipleOf5PriceHeightInsideMount = inchPricesAfterHeightInsideMountRomanBlindsRoomDarkening[prevInchHeightInsideMount];
      setnewSetPriceInchesHeightInsideMountRomanBlindsRoomDarkening(nearestMultipleOf5PriceHeightInsideMount !== undefined ? nearestMultipleOf5PriceHeightInsideMount : "");
      ...
      console.log("Price for multiple of 5:", inchPricesAfterHeightInsideMountRomanBlindsRoomDarkening[inchesHeightInsideMount]);
    }
  };
  ...
  const handleScrolledInchesWhenClickedHeightOutsideMount = (inchesHeightOutsideMount) => {
    ...
    // Retrieve the price associated with the selected inch
    const newSetPriceHeightOutsideMount = inchPricesAfterHeightOutsideMountRomanBlindsRoomDarkening[inchesHeightOutsideMount];
    setnewSetPriceInchesHeightOutsideMountRomanBlindsRoomDarkening(newSetPriceHeightOutsideMount !== undefined ? newSetPriceHeightOutsideMount : "");
    ...
    if (newSetPriceHeightOutsideMount === undefined && inchesHeightOutsideMount % 5 !== 0) {
      ...
      const nearestMultipleOf5PriceHeightOutsideMount = inchPricesAfterHeightOutsideMountRomanBlindsRoomDarkening[prevInchHeightOutsideMount];
      setnewSetPriceInchesHeightOutsideMountRomanBlindsRoomDarkening(nearestMultipleOf5PriceHeightOutsideMount !== undefined ? nearestMultipleOf5PriceHeightOutsideMount : "");
      ...
      // Log the price of the multiple of 5 when clicked
      console.log("Price for multiple of 5:", inchPricesAfterHeightOutsideMountRomanBlindsRoomDarkening[inchesHeightOutsideMount]);
    }
  };
  ...
  const calculateSumTotal = () => {
    let priceHeightInsideMount = parseFloat(newSetPriceInchesHeightInsideMountRomanBlindsRoomDarkening) || 0;
    let priceWidthInsideMount = parseFloat(inchPricesAfterWidthInsideMountRomanBlindsRoomDarkening[selectedInchesWidthInsideMount]) || 0;
    let priceHeightOutsideMount = parseFloat(newSetPriceInchesHeightOutsideMountRomanBlindsRoomDarkening) || 0;
    let priceWidthOutsideMount = parseFloat(inchPricesAfterWidthOutsideMountRomanBlindsRoomDarkening[selectedInchesWidthOutsideMount]) || 0;
  ...
  const handleClickInside_And_Outside_Ellipses = (ellipseNumber) => {
    ...
    if (ellipseNumber === 1) {
      ...
      setnewSetPriceInchesHeightOutsideMountRomanBlindsRoomDarkening(false);
      setnewSetPriceInchesWidthOutsideMountRomanBlindsRoomDarkening(false);
      setActiveDimensionsinsideMount("insideMount");
      setActiveDimensionsoutsideMount("");
      ...
      setnewSetPriceInchesHeightInsideMountRomanBlindsRoomDarkening(false);
      setnewSetPriceInchesWidthInsideMountRomanBlindsRoomDarkening(false);
                ...
                <div className={styles.top_title_area}>
                  ...
                  <span className={styles.product_title_styles_styles_and_product_roomname}>
                    <h1 className={styles.product_title_styles}>
                      {productName1RomanBlindsRoomDarkening}
                    </h1>
                    <h1 className={styles.product_roomname}>
                      <p>Room Name:</p> <p>{roomnameRomanBlindsRoomDarkening}</p>
                    </h1>
                  </span>

                  <h1 className={styles.product_lightening_styles}>
                    {productName2RomanBlindsRoomDarkening}
                  </h1>
                            ...
                            <div className={styles.bottom_portion_ruler_and_stuff}>
                              ...
                              <div className={styles.inches_and_fractions_and_ruler_group}>
                                ...
                                <div className={styles.key_locker2}>
                                  <h1>
                                    Price Width Inside Mount: ($) {inchPricesAfterWidthInsideMountRomanBlindsRoomDarkening[selectedInchesWidthInsideMount] !== undefined
                                      ? inchPricesAfterWidthInsideMountRomanBlindsRoomDarkening[selectedInchesWidthInsideMount]
                          ...
                          <div className={styles.bottom_portion_ruler_and_stuff_wrapper}>
                            ...
                            <div className={styles.bottom_portion_ruler_and_stuff}>
                              ...
                              <div className={styles.inches_and_fractions_and_ruler_group}>
                                ...
                                <div className={styles.key_locker2}>
                                  <h1>
                                    Price Width Outside Mount: ($) {inchPricesAfterWidthOutsideMountRomanBlindsRoomDarkening
                                    [selectedInchesWidthOutsideMount] !== undefined
                                      ? inchPricesAfterWidthOutsideMountRomanBlindsRoomDarkening[selectedInchesWidthOutsideMount]
                                      : "no price set for this value"}
                                  </h1>
                                </div>
                              ...
                              <div className={styles.inches_and_fractions_and_ruler_group}>
                                ...
                                <div className={styles.key_locker2}>
                                  <h1>
                                    Price Height Outside Mount: ($) {newSetPriceInchesHeightOutsideMountRomanBlindsRoomDarkening !== undefined
                      ...
                      <div className={styles.select_chain_options___side}>
                        <div className={styles.select_chain_option1_options}>
                          ...
                          <div className={styles.wand_subtitle}>
                            <span className={styles.price_bar}>${WandPriceCMSRomanBlindsRoomDarkening}</span>
                          </div>
                      ...
                      <div className={styles.select_chain_options___side}>
                        ...
                        <div className={styles.select_chain_option2_options}>
                          ...
                          <div className={styles.cord_less_subtitle}>
                            <span className={styles.price_bar}>${cordlesspriceCMSRomanBlindsRoomDarkening}</span>
                          </div>
                      ...
                      <div className={styles.select_chain_options___side}>
                        ...
                        <div className={styles.select_chain_option3_options}>
                          ...
                          <div className={styles.motorized_subtitle}>
                            <span className={styles.price_bar}>${motorizedpriceCMSRomanBlindsRoomDarkening}</span>
                          </div>
                  ...
                  <div className={styles.order_items_list}>
                    ...
                    <div className={styles.description_and_answer}>
                      ...
                      <div className={styles.answers_answers}>
                        {productName1RomanBlindsRoomDarkening.charAt(0).toUpperCase() + productName1RomanBlindsRoomDarkening.slice(1)}
                      </div>
                    ...
                    <div className={styles.description_and_answer}>
                      ...
                      <div className={styles.answers_answers}>
                        {productName2RomanBlindsRoomDarkening.charAt(0).toUpperCase() + productName2RomanBlindsRoomDarkening.slice(1)}
                      </div>
