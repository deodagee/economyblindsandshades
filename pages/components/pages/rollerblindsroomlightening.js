// C:\Users\User\economyblindsandshadesjs\pages\components\pages\rollerblindsroomlightening.js
...
const RollerBlindsRoomLightening = () => {
  ...
  const fetchLatestData = async () => {
    try {
      ...
      if (latestData) {
        ...
        const inchPricesWidthInsideMount = JSON.parse(latestData.inchPricesAfterWidthInsideMountRollerBlindsRoomLightening || "{}");

        setinchPricesAfterWidthInsideMountRollerBlindsRoomLightening(inchPricesWidthInsideMount);

        const inchPricesWidthOutsideMount = JSON.parse(latestData.inchPricesAfterWidthOutsideMountRollerBlindsRoomLightening || "{}");
        setinchPricesAfterWidthOutsideMountRollerBlindsRoomLightening(inchPricesWidthOutsideMount);

        const inchPricesHeightInsideMount = JSON.parse(latestData.inchPricesAfterHeightInsideMountRollerBlindsRoomLightening || "{}");
        setinchPricesAfterHeightInsideMountRollerBlindsRoomLightening(inchPricesHeightInsideMount);

        const inchPricesHeightOutsideMount = JSON.parse(latestData.inchPricesAfterHeightOutsideMountRollerBlindsRoomLightening || "{}");
        setinchPricesAfterHeightOutsideMountRollerBlindsRoomLightening(inchPricesHeightOutsideMount);



        const lastSetPriceWidthInsideMount = inchPricesWidthInsideMount[selectedInchesWidthInsideMount];
        setnewSetPriceInchesWidthInsideMountRollerBlindsRoomLightening(lastSetPriceWidthInsideMount);

        const lastSetPriceWidthOutsideMount = inchPricesWidthOutsideMount[selectedInchesWidthOutsideMount];
        setnewSetPriceInchesWidthOutsideMountRollerBlindsRoomLightening(lastSetPriceWidthOutsideMount);

        const lastSetPriceHeightInsideMount = inchPricesHeightInsideMount[selectedInchesHeightInsideMount];
        setnewSetPriceInchesHeightInsideMountRollerBlindsRoomLightening(lastSetPriceHeightInsideMount);

        const lastSetPriceHeightOutsideMount = inchPricesHeightOutsideMount[selectedInchesHeightOutsideMount];
        setnewSetPriceInchesHeightOutsideMountRollerBlindsRoomLightening(lastSetPriceHeightOutsideMount);
  ...
  const handleLiftFeatureEllipsess = (ellipseNumber) => {
    ...
    switch (ellipseNumber) {
      case 1:
        newTotalPrice = WandPriceCMSRollerBlindsRoomLightening;
        break;

      case 2:
        newTotalPrice = cordlesspriceCMSRollerBlindsRoomLightening;
        break;

      case 3:
        newTotalPrice = motorizedpriceCMSRollerBlindsRoomLightening;
        break;
  ...
  const [RollerBlindsRoomLighteningContent, setRollerBlindsRoomLighteningContent] = useState('');

  useEffect(() => {
    const RollerBlindsRoomLighteningElement = document.querySelector(`.${styles.room_darkening_element}`);
    if (RollerBlindsRoomLighteningElement) {
      setRollerBlindsRoomLighteningContent(RollerBlindsRoomLighteningElement.textContent || RollerBlindsRoomLighteningElement.innerText);
    }
  }, []);
  ...
  const handleScrolledInchesWhenClickedHeightInsideMount = (inchesHeightInsideMount) => {
    ...
    const newSetPriceHeightInsideMount = inchPricesAfterHeightInsideMountRollerBlindsRoomLightening[inchesHeightInsideMount];
    setnewSetPriceInchesHeightInsideMountRollerBlindsRoomLightening(newSetPriceHeightInsideMount !== undefined ? newSetPriceHeightInsideMount : "");
    ...
    if (newSetPriceHeightInsideMount === undefined && inchesHeightInsideMount % 5 !== 0) {
      ...
      const nearestMultipleOf5PriceHeightInsideMount = inchPricesAfterHeightInsideMountRollerBlindsRoomLightening[prevInchHeightInsideMount];
      setnewSetPriceInchesHeightInsideMountRollerBlindsRoomLightening(nearestMultipleOf5PriceHeightInsideMount !== undefined ? nearestMultipleOf5PriceHeightInsideMount : "");
      ...
      console.log("Price for multiple of 5:", inchPricesAfterHeightInsideMountRollerBlindsRoomLightening[inchesHeightInsideMount]);
    }
  };
  ...
  const handleScrolledInchesWhenClickedHeightOutsideMount = (inchesHeightOutsideMount) => {
    ...
    // Retrieve the price associated with the selected inch
    const newSetPriceHeightOutsideMount = inchPricesAfterHeightOutsideMountRollerBlindsRoomLightening[inchesHeightOutsideMount];
    setnewSetPriceInchesHeightOutsideMountRollerBlindsRoomLightening(newSetPriceHeightOutsideMount !== undefined ? newSetPriceHeightOutsideMount : "");
    ...
    if (newSetPriceHeightOutsideMount === undefined && inchesHeightOutsideMount % 5 !== 0) {
      ...
      const nearestMultipleOf5PriceHeightOutsideMount = inchPricesAfterHeightOutsideMountRollerBlindsRoomLightening[prevInchHeightOutsideMount];
      setnewSetPriceInchesHeightOutsideMountRollerBlindsRoomLightening(nearestMultipleOf5PriceHeightOutsideMount !== undefined ? nearestMultipleOf5PriceHeightOutsideMount : "");
      ...
      // Log the price of the multiple of 5 when clicked
      console.log("Price for multiple of 5:", inchPricesAfterHeightOutsideMountRollerBlindsRoomLightening[inchesHeightOutsideMount]);
    }
  };
  ...
  const calculateSumTotal = () => {
    ...
    switch (active_wand_cordless_motorized) {
      ...
      case 2:
        ...
        priceHeightInsideMount += parseFloat(cordlesspriceCMSRollerBlindsRoomLightening) || 0;
        break;
      case 3:
        // If "motorized" option is selected
        priceHeightInsideMount += parseFloat(motorizedpriceCMSRollerBlindsRoomLightening) || 0;
        break;
      default:
                ...
                <div className={styles.top_title_area}>
                  ...
                  <span className={styles.product_title_styles_styles_and_product_roomname}>
                    <h1 className={styles.product_title_styles}>
                      {productName1RollerBlindsRoomLightening}
                    </h1>
                    <h1 className={styles.product_roomname}>
                      <p>Room Name:</p> <p>{roomnameRollerBlindsRoomLightening}</p>
                    </h1>
                  </span>

                  <h1 className={styles.product_lightening_styles}>
                    {productName2RollerBlindsRoomLightening}
                  </h1>
                            ...
                            <div className={styles.bottom_portion_ruler_and_stuff}>
                              ...
                              <div className={styles.inches_and_fractions_and_ruler_group}>
                                ...
                                <div className={styles.key_locker2}>
                                  <h1>
                                    Price Width Inside Mount: ($) {inchPricesAfterWidthInsideMountRollerBlindsRoomLightening[selectedInchesWidthInsideMount] !== undefined
                                      ? inchPricesAfterWidthInsideMountRollerBlindsRoomLightening[selectedInchesWidthInsideMount]
                          ...
                          <div className={styles.bottom_portion_ruler_and_stuff_wrapper}>
                            ...
                            <div className={styles.bottom_portion_ruler_and_stuff}>
                              ...
                              <div className={styles.inches_and_fractions_and_ruler_group}>
                                ...
                                <div className={styles.key_locker2}>
                                  <h1>
                                    Price Height Outside Mount: ($) {newSetPriceInchesHeightOutsideMountRollerBlindsRoomLightening !== undefined
                      ...
                      <div className={styles.select_chain_options___side}>
                        <div className={styles.select_chain_option1_options}>
                          ...
                          <div className={styles.wand_subtitle}>
                            ...
                            <span>Free</span>
                            <span className={styles.price_bar}>${WandPriceCMSRollerBlindsRoomLightening}</span>
                          </div>
                      ...
                      <div className={styles.select_chain_options___side}>
                        ...
                        <div className={styles.select_chain_option2_options}>
                          ...
                          <div className={styles.cord_less_subtitle}>
                            <span className={styles.price_bar}>${cordlesspriceCMSRollerBlindsRoomLightening}</span>
                          </div>
                      ...
                      <div className={styles.select_chain_options___side}>
                        ...
                        <div className={styles.select_chain_option3_options}>
                          ...
                          <div className={styles.motorized_subtitle}>
                            <span className={styles.price_bar}>${motorizedpriceCMSRollerBlindsRoomLightening}</span>
                          </div>
                  ...
                  <div className={styles.order_items_list}>
                    ...
                    <div className={styles.description_and_answer}>
                      ...
                      <div className={styles.answers_answers}>
                        {productName1RollerBlindsRoomLightening.charAt(0).toUpperCase() + productName1RollerBlindsRoomLightening.slice(1)}
                      </div>
                    ...
                    <div className={styles.description_and_answer}>
                      ...
                      <div className={styles.answers_answers}>
                        {productName2RollerBlindsRoomLightening.charAt(0).toUpperCase() + productName2RollerBlindsRoomLightening.slice(1)}
                      </div>
...
export default RollerBlindsRoomLightening;
