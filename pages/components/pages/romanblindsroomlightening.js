...
import styles from '../../../styles/components/pages/romanblinds.module.css';
...
const RomanBlindsRoomLightening = () => {
  ...
  const fetchLatestData = async () => {
    try {
      ...
      if (latestData) {
        ...
        const inchPricesWidthInsideMount = JSON.parse(latestData.inchPricesAfterWidthInsideMountRomanBlindsRoomLightening || "{}");

        setinchPricesAfterWidthInsideMountRomanBlindsRoomLightening(inchPricesWidthInsideMount);

        const inchPricesWidthOutsideMount = JSON.parse(latestData.inchPricesAfterWidthOutsideMountRomanBlindsRoomLightening || "{}");
        setinchPricesAfterWidthOutsideMountRomanBlindsRoomLightening(inchPricesWidthOutsideMount);

        const inchPricesHeightInsideMount = JSON.parse(latestData.inchPricesAfterHeightInsideMountRomanBlindsRoomLightening || "{}");
        setinchPricesAfterHeightInsideMountRomanBlindsRoomLightening(inchPricesHeightInsideMount);

        const inchPricesHeightOutsideMount = JSON.parse(latestData.inchPricesAfterHeightOutsideMountRomanBlindsRoomLightening || "{}");
        setinchPricesAfterHeightOutsideMountRomanBlindsRoomLightening(inchPricesHeightOutsideMount);



        const lastSetPriceWidthInsideMount = inchPricesWidthInsideMount[selectedInchesWidthInsideMount];
        setnewSetPriceInchesWidthInsideMountRomanBlindsRoomLightening(lastSetPriceWidthInsideMount);

        const lastSetPriceWidthOutsideMount = inchPricesWidthOutsideMount[selectedInchesWidthOutsideMount];
        setnewSetPriceInchesWidthOutsideMountRomanBlindsRoomLightening(lastSetPriceWidthOutsideMount);

        const lastSetPriceHeightInsideMount = inchPricesHeightInsideMount[selectedInchesHeightInsideMount];
        setnewSetPriceInchesHeightInsideMountRomanBlindsRoomLightening(lastSetPriceHeightInsideMount);

        const lastSetPriceHeightOutsideMount = inchPricesHeightOutsideMount[selectedInchesHeightOutsideMount];
        setnewSetPriceInchesHeightOutsideMountRomanBlindsRoomLightening(lastSetPriceHeightOutsideMount);
  ...
  const handleLiftFeatureEllipsess = (ellipseNumber) => {
    ...
    switch (ellipseNumber) {
      case 1:
        newTotalPrice = WandPriceCMSRomanBlindsRoomLightening;
        break;

      case 2:
        newTotalPrice = cordlesspriceCMSRomanBlindsRoomLightening;
        break;

      case 3:
        newTotalPrice = motorizedpriceCMSRomanBlindsRoomLightening;
        break;
  ...
  const getTotalPrice = () => {
    ...
    switch (active_inside_outside_ellipse) {
      case 1:
        totalPrice = totalpricecalculated + (active_wand_left_choice === 4 ? WandPriceCMSZebrablindsRomanBlindsRoomLightening : 0) + (active_wand_right_choice === 5 ? WandPriceCMSZebrablindsRomanBlindsRoomLightening : 0);
        break;
      case 2:
  ...
  const [RomanBlindsRoomLighteningContent, setRomanBlindsRoomLighteningContent] = useState('');

  useEffect(() => {
    const RomanBlindsRoomLighteningElement = document.querySelector(`.${styles.room_darkening_element}`);
    if (RomanBlindsRoomLighteningElement) {
      setRomanBlindsRoomLighteningContent(RomanBlindsRoomLighteningElement.textContent || RomanBlindsRoomLighteningElement.innerText);
    }
  }, []);
  ...
  const handleScrolledInchesWhenClickedHeightInsideMount = (inchesHeightInsideMount) => {
    ...
    const newSetPriceHeightInsideMount = inchPricesAfterHeightInsideMountRomanBlindsRoomLightening[inchesHeightInsideMount];
    setnewSetPriceInchesHeightInsideMountRomanBlindsRoomLightening(newSetPriceHeightInsideMount !== undefined ? newSetPriceHeightInsideMount : "");
    ...
    if (newSetPriceHeightInsideMount === undefined && inchesHeightInsideMount % 5 !== 0) {
      ...
      const nearestMultipleOf5PriceHeightInsideMount = inchPricesAfterHeightInsideMountRomanBlindsRoomLightening[prevInchHeightInsideMount];
      setnewSetPriceInchesHeightInsideMountRomanBlindsRoomLightening(nearestMultipleOf5PriceHeightInsideMount !== undefined ? nearestMultipleOf5PriceHeightInsideMount : "");
      ...
      console.log("Price for multiple of 5:", inchPricesAfterHeightInsideMountRomanBlindsRoomLightening[inchesHeightInsideMount]);
    }
  };
  ...
  const handleScrolledInchesWhenClickedHeightOutsideMount = (inchesHeightOutsideMount) => {
    ...
    // Retrieve the price associated with the selected inch
    const newSetPriceHeightOutsideMount = inchPricesAfterHeightOutsideMountRomanBlindsRoomLightening[inchesHeightOutsideMount];
    setnewSetPriceInchesHeightOutsideMountRomanBlindsRoomLightening(newSetPriceHeightOutsideMount !== undefined ? newSetPriceHeightOutsideMount : "");
    ...
    if (newSetPriceHeightOutsideMount === undefined && inchesHeightOutsideMount % 5 !== 0) {
      ...
      const nearestMultipleOf5PriceHeightOutsideMount = inchPricesAfterHeightOutsideMountRomanBlindsRoomLightening[prevInchHeightOutsideMount];
      setnewSetPriceInchesHeightOutsideMountRomanBlindsRoomLightening(nearestMultipleOf5PriceHeightOutsideMount !== undefined ? nearestMultipleOf5PriceHeightOutsideMount : "");
      ...
      // Log the price of the multiple of 5 when clicked
      console.log("Price for multiple of 5:", inchPricesAfterHeightOutsideMountRomanBlindsRoomLightening[inchesHeightOutsideMount]);
    }
  };
  ...
  const calculateSumTotal = () => {
    let priceHeightInsideMount = parseFloat(newSetPriceInchesHeightInsideMountRomanBlindsRoomLightening) || 0;
    let priceWidthInsideMount = parseFloat(inchPricesAfterWidthInsideMountRomanBlindsRoomLightening[selectedInchesWidthInsideMount]) || 0;
    let priceHeightOutsideMount = parseFloat(newSetPriceInchesHeightOutsideMountRomanBlindsRoomLightening) || 0;
    let priceWidthOutsideMount = parseFloat(inchPricesAfterWidthOutsideMountRomanBlindsRoomLightening[selectedInchesWidthOutsideMount]) || 0;
    ...
    switch (active_wand_cordless_motorized) {
      ...
      case 1:
        ...
        priceHeightInsideMount += parseFloat(WandPriceCMSRomanBlindsRoomLightening) || 0;
        break;
      case 2:
        // If "cordless" option is selected
        priceHeightInsideMount += parseFloat(cordlesspriceCMSRomanBlindsRoomLightening) || 0;
        break;
      case 3:
        // If "motorized" option is selected
        priceHeightInsideMount += parseFloat(motorizedpriceCMSRomanBlindsRoomLightening) || 0;
        break;
      default:
  ...
  const handleAddToCart = async () => {
    ...
    if (!productName1RomanBlindsRoomLightening) missingValues.push("productName1RomanBlindsRoomLightening");
    if (!productName2RomanBlindsRoomLightening) missingValues.push("productName2RomanBlindsRoomLightening");
    if (!roomnameRomanBlindsRoomLightening) missingValues.push("roomnameRomanBlindsRoomLightening");
    if (
      !WandPriceCMSRomanBlindsRoomLightening &&
      !cordlesspriceCMSRomanBlindsRoomLightening &&
      !motorizedpriceCMSRomanBlindsRoomLightening
    ) missingValues.push("WandPriceCMSRomanBlindsRoomLightening", "cordlesspriceCMSRomanBlindsRoomLightening", "motorizedpriceCMSRomanBlindsRoomLightening");
  ...
  const handleClickInside_And_Outside_Ellipses = (ellipseNumber) => {
    ...
    if (ellipseNumber === 1) {
      ...
      setnewSetPriceInchesHeightOutsideMountRomanBlindsRoomLightening(false);
      setnewSetPriceInchesWidthOutsideMountRomanBlindsRoomLightening(false);
      setActiveDimensionsinsideMount("insideMount");
      setActiveDimensionsoutsideMount("");

      setactive_wand_cordless_motorized(false);
      setWandPriceCMSRomanBlindsRoomLightening(false);
      setcordlesspriceCMSRomanBlindsRoomLightening(false);
      setmotorizedpriceCMSRomanBlindsRoomLightening(false);
      ...
      setnewSetPriceInchesHeightInsideMountRomanBlindsRoomLightening(false);
      setnewSetPriceInchesWidthInsideMountRomanBlindsRoomLightening(false);
                ...
                <div className={styles.top_title_area}>
                  ...
                  <span className={styles.product_title_styles_styles_and_product_roomname}>
                    <h1 className={styles.product_title_styles}>
                      {productName1RomanBlindsRoomLightening}
                    </h1>
                    <h1 className={styles.product_roomname}>
                      <p>Room Name:</p> <p>{roomnameRomanBlindsRoomLightening}</p>
                    </h1>
                  </span>

                  <h1 className={styles.product_lightening_styles}>
                    {productName2RomanBlindsRoomLightening}
                  </h1>
                            ...
                            <div className={styles.bottom_portion_ruler_and_stuff}>
                              ...
                              <div className={styles.inches_and_fractions_and_ruler_group}>
                                ...
                                <div className={styles.key_locker2}>
                                  <h1>
                                    Price Width Inside Mount: ($) {inchPricesAfterWidthInsideMountRomanBlindsRoomLightening[selectedInchesWidthInsideMount] !== undefined
                                      ? inchPricesAfterWidthInsideMountRomanBlindsRoomLightening[selectedInchesWidthInsideMount]
                          ...
                          <div className={styles.bottom_portion_ruler_and_stuff_wrapper}>
                            ...
                            <div className={styles.bottom_portion_ruler_and_stuff}>
                              ...
                              <div className={styles.inches_and_fractions_and_ruler_group}>
                                ...
                                <div className={styles.key_locker2}>
                                  <h1>
                                    Price Width Outside Mount: ($) {inchPricesAfterWidthOutsideMountRomanBlindsRoomLightening
                                    [selectedInchesWidthOutsideMount] !== undefined
                                      ? inchPricesAfterWidthOutsideMountRomanBlindsRoomLightening[selectedInchesWidthOutsideMount]
                                      : "no price set for this value"}
                                  </h1>
                                </div>
                              ...
                              <div className={styles.inches_and_fractions_and_ruler_group}>
                                ...
                                <div className={styles.key_locker2}>
                                  <h1>
                                    Price Height Outside Mount: ($) {newSetPriceInchesHeightOutsideMountRomanBlindsRoomLightening !== undefined
                      ...
                      <div className={styles.select_chain_options___side}>
                        <div className={styles.select_chain_option1_options}>
                          ...
                          <div className={styles.wand_subtitle}>
                            <span className={styles.price_bar}>${WandPriceCMSRomanBlindsRoomLightening}</span>
                          </div>
                      ...
                      <div className={styles.select_chain_options___side}>
                        ...
                        <div className={styles.select_chain_option2_options}>
                          ...
                          <div className={styles.cord_less_subtitle}>
                            <span className={styles.price_bar}>${cordlesspriceCMSRomanBlindsRoomLightening}</span>
                          </div>
                      ...
                      <div className={styles.select_chain_options___side}>
                        ...
                        <div className={styles.select_chain_option3_options}>
                          ...
                          <div className={styles.motorized_subtitle}>
                            <span className={styles.price_bar}>${motorizedpriceCMSRomanBlindsRoomLightening}</span>
                          </div>
                  ...
                  <div className={styles.order_items_list}>
                    ...
                    <div className={styles.description_and_answer}>
                      ...
                      <div className={styles.answers_answers}>
                        {productName1RomanBlindsRoomLightening.charAt(0).toUpperCase() + productName1RomanBlindsRoomLightening.slice(1)}
                      </div>
                    ...
                    <div className={styles.description_and_answer}>
                      ...
                      <div className={styles.answers_answers}>
                        {productName2RomanBlindsRoomLightening.charAt(0).toUpperCase() + productName2RomanBlindsRoomLightening.slice(1)}
                      </div>
...
export default RomanBlindsRoomLightening;
