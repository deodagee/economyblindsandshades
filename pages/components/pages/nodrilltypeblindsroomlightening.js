...
const NoDrillTypeBlindsRoomLightening = () => {
  ...
  const calculateSumTotal = () => {
    ...
    let priceHeightOutsideMount = parseFloat(newSetPriceInchesHeightOutsideMountNoDrillTypeBlindsRoomLightening) || 0;
    let priceWidthOutsideMount = parseFloat(inchPricesAfterWidthOutsideMountNoDrillTypeBlindsRoomLightening[selectedInchesWidthOutsideMount]) || 0;
  ...
  const handleClickInside_And_Outside_Ellipses = (ellipseNumber) => {
    ...
    if (ellipseNumber === 1) {
      ...
      setnewSetPriceInchesHeightOutsideMountNoDrillTypeBlindsRoomLightening(false);
      setnewSetPriceInchesWidthOutsideMountNoDrillTypeBlindsRoomLightening(false);
      setActiveDimensionsinsideMount("insideMount");
      setActiveDimensionsoutsideMount("");
      ...
      setnewSetPriceInchesHeightInsideMountNoDrillTypeBlindsRoomLightening(false);
      setnewSetPriceInchesWidthInsideMountNoDrillTypeBlindsRoomLightening(false);
